        ...
        <dl class="menu-item-bar">
            <dt class="menu-item-handle">
                <label class="item-title" for="menu-item-checkbox-<?php echo $item_id; ?>">
                    ...
                    <span class="is-submenu brando-sub-menu-text" <?php echo $submenu_text; ?>><?php _e( 'sub item' ); ?></span>
                </label>
                <span class="item-controls">
                    ...
                    ?>"><span class="screen-reader-text"><?php esc_html_e( 'Edit','brando' ); ?></span></a>
                </span>
            </dt>
        </dl>
...
class Brando_Nav_Menu extends Walker_Nav_Menu {
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        $item_output .= '</a>';
        $item_output .= (($item -> hasChildren && $depth == 0 ) ? '<i class="fas fa-angle-down mobile-menu-icon"></i>' : '' );
        $item_output .= (($item -> hasChildren && $depth == 1 ) ? '<i class="fas fa-angle-right mobile-menu-icon"></i>' : '' );
