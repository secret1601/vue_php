...
if ( ! function_exists( 'brando_plugin_activation' ) ) {
    function brando_plugin_activation() {
        $brando_newsletter_plugin = '';
        if( !defined( 'XYZ_EM_PLUGIN_FILE' ) ){
            $brando_newsletter_plugin = array(
                'name'               => esc_html__('Mailchimp for WordPress','brando'),                          // The plugin name.
    	...
    	$brando_plugin_list = array(	
            ...
            array(
                'name'               => esc_html__('WPBakery Page Builder','brando'),                    // The plugin name
