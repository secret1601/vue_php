...
$this->sections[] = array(
    ...
    'fields' => array(
    	array(
            ...
            'type'     => 'switch',
            'title'    => esc_html__('Enable Footer', 'brando'),
            'default'  => true,
        ),
        array(
        ...
        array(
            'id' => 'brando_footer_logo_url',
            'type' => 'text',
            'title' => esc_html__('Footer Logo Url', 'brando'),
            'default' => '',
        ...
        array(
            'id'       => 'brando_enable_scrolltotop_button_position',
            'type'     => 'switch',
            'title'    => esc_html__('ScrollToTop Button Right Position', 'brando'),
            'subtitle' => esc_html__( 'If off, a ScrollToTop Button will be displayed in Left Position.', 'brando' ),
            'required'  => array('brando_enable_scrolltotop_button', 'equals', '1'),
            'default'  => true,
            '1'        => 'On',
            '0'        => 'Off',
        ),
        array(
            'id'       => 'brando_enable_scrolltotop_mobile_device',
            'type'     => 'switch',
            'title'    => esc_html__('ScrollToTop Mobile On/Off', 'brando' ),
            'subtitle' => esc_html__( 'If off, a ScrollToTop Button will be displayed in Mobile.', 'brando' ),
            'required'  => array('brando_enable_scrolltotop_button', 'equals', '1'),
            'default'  => false,
        ),
    )
