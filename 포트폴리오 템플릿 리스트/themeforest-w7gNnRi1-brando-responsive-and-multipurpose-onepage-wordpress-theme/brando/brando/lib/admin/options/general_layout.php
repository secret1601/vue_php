...
$this->sections[] = array(
    ...
    'fields' => array(
        ...
        array(
            'id'       => 'brando_breadcrumb_hide_title',
            'type'     => 'switch',
            'title'    => esc_html__('Enable Breadcrumb Title', 'brando'),
            'default'  => true,
            'required'  => array('brando_enable_breadcrumb', 'equals', array('1') ),
        ),
        /* Body Background */
        ...
        array(
            'id'=>'brando_blog_page_show_feature_image',
            'type' => 'switch', 
            'title' => esc_html__('Show Post Featured Image Only', 'brando'),
            'default' => false,
            'required'  => array('brando_blog_page_show_thumbnail', 'equals', array('1') ),
        ),
        array(
        ...
        array(
            'id'       => 'brando_enable_category_breadcrumb_post',
            'type'     => 'switch',
            'title'    => esc_html__('Enable Category In Breadcrumb', 'brando'),
            'default'  => false,
            'required'  => array('brando_enable_breadcrumb_post', 'equals', array('1') ),
        ),
        array(
            'id'       => 'brando_breadcrumb_hide_title_post',
            'type'     => 'switch',
            'title'    => esc_html__('Brando Enable Breadcrumb Title', 'brando'),
            'default'  => true,
            'required'  => array('brando_enable_breadcrumb_post', 'equals', array('1') ),
        ),
        array(
        ...
        array(
            'id'       => 'brando_breadcrumb_hide_title_portfolio',
            'type'     => 'switch',
            'title'    => esc_html__('Enable Breadcrumb Title', 'brando'),
            'default'  => true,
            'required'  => array('brando_enable_breadcrumb_portfolio', 'equals', array('1') ),
        ),
        array(
            'id'       => 'brando_enable_category_breadcrumb_portfolio',
            'type'     => 'switch',
            'title'    => esc_html__('Enable Category In Breadcrumb', 'brando'),
            'default'  => false,
            'required'  => array('brando_enable_breadcrumb_portfolio', 'equals', array('1') ),
        ...
        array(
            'id'=>'brando_general_show_feature_image',
            'type' => 'switch', 
            'title' => esc_html__('Show Featured Image Only', 'brando'),
            'default' => false,
            'required'  => array('brando_general_show_thumbnail', 'equals', array('1') ),
        ),
        array(
        ...
        array(
            'id'=>'brando_general_show_content',
            'type' => 'switch', 
            'title' => esc_html__('Show Post Content', 'brando'),
            'default' => true,
            'required'  => array('brando_general_grid_layout', 'equals', array('grid','classic') ),
