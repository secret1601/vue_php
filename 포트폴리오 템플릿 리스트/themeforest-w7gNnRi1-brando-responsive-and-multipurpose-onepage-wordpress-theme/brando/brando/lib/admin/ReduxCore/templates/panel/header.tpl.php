...
<div id="redux-header">
    <?php if ( ! empty( $this->parent->args['display_name'] ) ) { ?>
        ...
        <div class="brando-head-right">
            ...
            $brando_live_support_url = 'https://www.themezaa.com';
            ?>
            <a href="<?php echo esc_url( $brando_live_site_url ); ?>/documentation/" target="_blank"><?php echo esc_html__('Online Documentation', 'brando'); ?></a>
                <span class="link_sep">|</span><a href="<?php echo esc_url( $brando_live_support_url ); ?>/support/" target="_blank"><?php echo esc_html__('Support Center', 'brando'); ?></a>
        </div>
        <div class="clear"></div>
    <?php } ?>
