    ...
    if ( ! class_exists( 'reduxCoreEnqueue' ) ) {
        class reduxCoreEnqueue {
            ...
            private function set_localized_data() {
                ...
                // For accordion custom tabs             
                wp_enqueue_script(
                    'brando-accordion',
                    ReduxFramework::$_url . 'assets/js/brando-accordion.js',
                    '',
                    '1.0',
                    true
                );
                wp_enqueue_script(
                    'brando-ajax-save',
                    ReduxFramework::$_url . 'assets/js/brando-ajax-save.js',
                    '',
                    '1.0',
                    true
                );
                 wp_localize_script(
                    'brando-ajax-save',
                    'brando_ajax_button_save',
                    array( 'adminajaxurl' => admin_url().'options.php' )
                );
