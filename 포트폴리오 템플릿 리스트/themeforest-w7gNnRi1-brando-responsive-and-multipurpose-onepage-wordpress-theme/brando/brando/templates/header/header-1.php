...
?>
    <nav class="navbar no-margin-bottom alt-font transparent-navbar-default header-vertical-center<?php echo esc_attr($brando_header_text_color);?><?php echo esc_attr( $brando_enable_non_sticky );?>"<?php echo esc_html( $brando_header_top_offset ); ?>>
        <div class="container navigation-menu">
            <div class="row">
                ...
                ?>
                    <div class="col-lg-3 col-md-2 pull-right sm-no-padding-left header-right text-right<?php echo esc_attr( $brando_call_to_action ) ?>">
