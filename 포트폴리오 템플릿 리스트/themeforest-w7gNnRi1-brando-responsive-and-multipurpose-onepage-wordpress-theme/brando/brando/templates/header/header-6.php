...
?>
    <nav class="navbar no-margin-bottom alt-font header-vertical-center<?php echo esc_attr($brando_header_text_color);?> transparent-header<?php echo esc_attr( $brando_enable_non_sticky );?>"<?php echo esc_html( $brando_header_top_offset ); ?>>
