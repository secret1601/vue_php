...
?>
    <nav class="navbar no-margin-bottom alt-font bg-white sidebar-nav <?php echo esc_attr($brando_header_text_color);?>"<?php echo esc_html( $brando_header_top_offset ) ?>>
            <div class="container navigation-menu">
                <div class="row">
                    ...
                    <?php if( is_active_sidebar($brando_header_sidebar) ){ ?>
                            <div class="col-md-12 margin-ten no-margin-lr sm-no-padding-left sidebar-nav-bottom<?php echo esc_attr( $brando_call_to_action ) ?>">
