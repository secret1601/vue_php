...
?>
    <nav class="navbar no-margin-bottom alt-font center-logo-header no-border bg-turquoise-blue header-vertical-center <?php echo esc_attr($brando_header_text_color);?><?php echo esc_attr( $brando_enable_non_sticky );?>"<?php echo esc_html( $brando_header_top_offset ) ?>>
            ...
            <div class="row text-center">
                <div class="navbar-header">
                    ...
                    if( isset( $brando_theme_settings['brando_retina_logo_height_general'] ) && !empty( $brando_theme_settings['brando_retina_logo_height_general'] ) ){
                        $brando_retina_height .= 'max-height:'.esc_attr($brando_theme_settings['brando_retina_logo_height_general']).'; ';

                    }elseif( isset( $brando_theme_settings['brando_retina_logo_height'] ) && !empty( $brando_theme_settings['brando_retina_logo_height'] ) ){
                        $brando_retina_height .= 'max-height:'.esc_attr($brando_theme_settings['brando_retina_logo_height']).'; ';
                    }
                    $brando_r_style  = '';
                    ?>
                ...
                ?>
                    <div class="col-lg-2 col-md-2 sm-no-padding-left pull-right header-right text-right<?php echo esc_attr( $brando_call_to_action ) ?>">
