...
if(is_search()):
    $brando_title .= esc_html( 'Search For', 'brando' );
elseif(is_author()):
...
$brando_enable_title = (isset($brando_options['brando_enable_general_title_wrapper'])) ? $brando_options['brando_enable_general_title_wrapper'] : '';
$brando_title_parallax_effect = (isset($brando_options['brando_general_title_parallax_effect'])) ? $brando_options['brando_general_title_parallax_effect'] : '';
if( $brando_enable_title == 1 || !isset($brando_options['brando_enable_general_title_wrapper']) ){
    $brando_post_class ='';
                    ...
                    echo '<div class="col-text-middle-main">';
                        echo '<div class="col-text-middle">';
                            echo '<div class="col-md-12 col-sm-12 text-center">';
                                if( $brando_title ){
                                    echo '<h1 class="alt-font white-text font-weight-600 xs-title-extra-large no-margin entry-title">'.esc_attr($brando_title).'</h1>';
                                }
                                if( $brando_desc ){
